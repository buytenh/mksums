...
hlsums:		hlsums.c hlsums_common.h make_hardlinks.c read_sum_files.c scan_inodes.c segment_inodes.c
		gcc -D_FILE_OFFSET_BITS=64 -O3 -Wall -g -o hlsums hlsums.c make_hardlinks.c read_sum_files.c scan_inodes.c segment_inodes.c `pkg-config --cflags --libs ivykis`
